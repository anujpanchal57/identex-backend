...
class Requisition:
    ...
    def add_requisition(self, requisition_name, timezone, currency, deadline, tnc="", cancelled=False, status=True, supplier_instructions=""):
    ...
    def insert(self, values, table="requisition_table"):
        try:
            ...
            self.__cursor.execute("""INSERT INTO requisitions (requisition_name, timezone, currency, deadline, supplier_instructions, 
            tnc, cancelled, status, created_at) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)""",
                                  (values['requisition_name'], values['timezone'], values['currency'],
